    ...
    <div class="mx-auto w-full max-w-md">
      ...
      <div class="mt-7 rounded-3xl border border-black/5 bg-white/90 p-4 shadow-card" data-node-id="178:253">
        <div class="space-y-4">
          ...
          <UiInput type="tel" label="Телефон" placeholder="+7 (___) ___-__-__" phone-mask autocomplete="tel"
            v-model="phone" />

          <UiInput label="Пароль" type="password" placeholder="Минимум 6 символов" v-model="password" />
        </div>
        ...
        <p class="mt-3 text-center text-xs font-semibold text-black/45" data-node-id="178:275">
