...
import type { BasketCookSummary, BasketLineItem } from "~/types";
...
<template>
  <div class="relative mx-auto min-h-screen w-full max-w-md bg-page-cream">
    ...
    <div v-if="!pending && !error && basket && basket.items.length > 0"
      class="pointer-events-none fixed inset-x-0 bottom-0 z-20 bg-linear-to-t from-page-cream from-65% to-transparent px-4 pb-[calc(1.25rem+env(safe-area-inset-bottom))] pt-3">
